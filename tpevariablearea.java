...
public class tpevariablearea{
    public static void main(String[]args){
        ...
        try{
            ...
            if (intervaloTiempo>maxTiempo){
                intervaloTiempo= maxTiempo;
            }
            ...
            while((alturaAguaTanque<alturaTanque)&&(tiempoInicial<intervaloTiempo)){
                alturaAguaTanque = alturaDeAguaInicial +(caudalEntrada-(alturaDeAguaInicial*modifCaudal/areaTanque))*tiempoInicial/areaTanque;
                tiempoInicial++;
                alturaDeAguaInicial=alturaAguaTanque;
                
                // informador c/2
                        if (alturaDeAguaInicial >= (alturaTanque/2) && pasaMitad==false){
                ...
                if(alturaAguaTanque == alturaTanque){
                    ...
                    while(alturaAguaTanque>0){
                        alturaAguaTanque = alturaDeAguaInicial +(0-(alturaDeAguaInicial*modifCaudal/areaTanque))*tiempoInicial/areaTanque;
                        tiempoInicial++;
                        alturaDeAguaInicial=alturaAguaTanque;
                    }
