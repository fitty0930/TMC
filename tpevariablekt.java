...
public class tpevariablekt{
    public static void main(String[]args){
        ...
        try{
            ...
            System.out.println("el caudal de salida final sera modif*tiempo");
            ...
            //llenado
            while((alturaAguaTanque<alturaTanque)&&(tiempoInicial<intervaloTiempo)&&(alturaAguaTanque>0)){
